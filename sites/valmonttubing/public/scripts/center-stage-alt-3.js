...
function centerStageInit(){
	...
	headerX = parseInt($("#center-stage li.show h1").css("left"));
	setupRotator();
...
function centerStageIn(){
	...
	$("#center-stage li.show h1").animate({left:headerX}, slideInSpeed, "easeInOutQuad");
	$("#center-stage li.show h2").animate({left:headerX}, slideInSpeed, "easeInOutQuad");
	var imageCounter = 0;
...
function resetCenterStage(){
	...
	$("#center-stage li.show h2").css("left", edgeDistance+"px").fadeIn(1);
