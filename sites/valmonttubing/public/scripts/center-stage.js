...
function centerStageIn(){
	...
	$("#center-stage li.show h2").delay(timeBetweenTransitions * (imageCounter + 1) + timeBetweenTransitions).fadeIn(slideInSpeed / 2);
...
function resetCenterStage(){
	...
	$("#center-stage li.show h2").css("right", edgeDistance + "px").fadeIn(1);
